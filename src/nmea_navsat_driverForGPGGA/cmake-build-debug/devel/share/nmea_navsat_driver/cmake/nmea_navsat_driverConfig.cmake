...
if("TRUE" STREQUAL "TRUE")
  set(nmea_navsat_driver_SOURCE_PREFIX /home/lab307/wk_scout/src/nmea_navsat_driver)
  set(nmea_navsat_driver_DEVEL_PREFIX /home/lab307/wk_scout/src/nmea_navsat_driver/cmake-build-debug/devel)
  ...
  set(nmea_navsat_driver_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nmea_navsat_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lab307/wk_scout/src/nmea_navsat_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT nmea_navsat_driver_NUM_DUMMY_TARGETS)
      set(nmea_navsat_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::nmea_navsat_driver::wrapped-linker-option${nmea_navsat_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR nmea_navsat_driver_NUM_DUMMY_TARGETS "${nmea_navsat_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::nmea_navsat_driver::wrapped-linker-option${nmea_navsat_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND nmea_navsat_driver_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lab307/wk_scout/src/nmea_navsat_driver/cmake-build-debug/devel/lib;/home/lab307/wk_scout/devel/lib;/home/lab307/tool_ws/devel/lib;/home/lab307/ws_livox/devel/lib;/opt/ros/kinetic/lib)
