...
public:
    ...
    */
    void imuHandler(const sensor_msgs::Imu::ConstPtr& imuMsg)
    {
        ...
        ROS_INFO("%lf<< imuRoll << %lf:  << imuPitch <<  %lf:  << imuYaw ",imuRoll,imuPitch,imuYaw);
    }
    ...
    */
    void imuDeskewInfo()
    {
        ...
        for (int i = 0; i < (int)imuQueue.size(); ++i)
        {
            ...
            //// TODO 这里直接将最近且早于lidar开始时刻的imu数据作为init 并且是否决定了直接坐标系RPY？
    ...
    */
    void findPosition(double relTime, float *posXCur, float *posYCur, float *posZCur)
    {
        ...
        *posXCur = 0; *posYCur = 0; *posZCur = 0;
        ...
        //// 可以debug出来odomIncreX，odomIncreY，odomIncreZ的量，考虑是否要加上
    ...
    */
    PointType deskewPoint(PointType *point, double relTime)
    {
        ...
        //ROS_WARN("timeScanCur %lf,pointTime%lf\n",timeScanCur,pointTime);
        ...
        if (firstPointFlag == true)
        {
            ...
            //ROS_WARN("lidar first point %lf,%lf,%lf",rotXCur,rotYCur,rotZCur);
        }
